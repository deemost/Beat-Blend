...
export default function GuestView( {count} ) {
    ...
    const handleButtonsClick = (str) => () => {
        ...
        if (str === "Spotify" && !spotifyAccessToken) {
            setWhichService("Host Not Logged Into Spotify!");
        }

        if (str === "Youtube" && !youtubeAccessToken) {
            setWhichService("Host Not Logged Into Youtube!");
        }
    };
                            ...
                            {whichService === "Spotify" ? (
                                ...
                                : whichService === "Apple Music" ? (
                                    ...
                                    : whichService === "Youtube" ? (
                                        ...
                                        : whichService === "Host Not Logged Into Spotify!" ? (whichService)

                                            : whichService === "Host Not Logged Into Youtube!" ? (whichService)
